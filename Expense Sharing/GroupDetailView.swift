...
struct GroupDetailView: View {
    ...
    var body: some View {
        VStack {
            // Navigation
            NavigationLink(destination: Text("Add User"), isActive: $showingAddUser) { EmptyView() }
            NavigationLink(destination: Text("Add Transaction"), isActive: $showingAddTransaction) { EmptyView() }
